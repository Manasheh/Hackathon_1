...
class Opportunities:
    ...
    def from_db(self,user_input_opp_name):
        try:
            ...
            item = Opportunities.add_item(opp_id, opp_name, opp_email, opp_description, region_id, shift_id, day_id, frequency_id, type_id, subtype_id)
        ...
        try:
            ...
            if check_opp(self.opp_name):
                ...
                query = f"""
                    ...
                    (SELECT region_id FROM region WHERE region_name = '{self.region_name}'),
                    {self.shift_id},{self.day_id},{self.frequency_id}, {self.type_id}, {self.subtype_id});"""
...
# save('Checking2','checking2@mail.com',
#      'Our mission is to check a program.',
#      '2','1','2','null','1','null')


# check_of('region','region_name','Hafa')
# print(check_of('region','region_name','Hafa'))
#     print('yes')
# opp = Opportunities.from_db('Checking2')
# opp.create_list_volunteers1()
# print(opp.opp_name, opp.frequency_id)
# # opp_for_rpint = " ".join(opp)
# # print(opp_for_rpint)
# print(type(opp))
...
# length = list_of('work_day')
# user_shift = int(input('What shift are you looking for a volunteer for?'))
